...
async function approveProfCurr(e) {
  ...
  if (res.status === 200) {
    ...
    // console.log(form);
    document.getElementById("unapprovedCards").removeChild(form.parentNode.parentNode.parentNode);
  ...
  setTimeout(()=>{alertSpace.removeChild(alertSpace.childNodes[0])}, 7000);
}
...
const TimeCardDisplay = ({timecard})=>{
  return (
    ...
    <input name="timecardId" id="timecardId" value={timecard._id} style={{display:"none"}}/>
    <Row form>
    <Col md={8}>
      <FormGroup>
      <Label for="uname">Name</Label>
      <Input type="text" value={timecard.studentName} name="uname" id="uname" disabled/>
      </FormGroup>
    </Col>
    </Row>
    <Row form>
    <Col md={8}>
        ...
        <Input type="text" value={timecard.month} name="month" id="month" disabled/>
        </FormGroup>
    </Col>
    </Row>
      <Row form>
      <Col md={8}>
          <FormGroup>
          <Label for="week1">Hours worked 1<sup>st</sup>-7<sup>th</sup></Label>
          <Input type="number" value={timecard.week1} name="week1" id="week1" disabled/>
          </FormGroup>
      </Col>
      </Row>
      <Row form>
      <Col md={8}>
          <FormGroup>
          <Label for="week2">Hours worked 8<sup>th</sup>-14<sup>th</sup></Label>
          <Input type="number" value={timecard.week2} name="week2" id="week2" disabled />
          </FormGroup>
      </Col>
      </Row>
      <Row form>
      <Col md={8}>
          <FormGroup>
          <Label for="week3">Hours worked 15<sup>th</sup>-21<sup>st</sup></Label>
          <Input type="number" value={timecard.week3} name="week3" id="week3" disabled />
          </FormGroup>
      </Col>
      </Row>
      <Row form>
      <Col md={8}>
          <FormGroup>
          <Label for="week4">Hours worked 22<sup>nd</sup>-28<sup>th</sup></Label>
          <Input type="number"value={timecard.week4} name="week4" id="week4" disabled />
          </FormGroup>
      </Col>
      </Row>
      <Row form>
      <Col md={8}>
          <FormGroup>
          <Label for="week5">Hours worked 29<sup>th</sup>-31<sup>th</sup></Label>
          <Input type="number" value={timecard.week5} name="week5" id="week5" disabled />
          </FormGroup>
      </Col>
      </Row>
  ...
  const {
    ...
    async function onSubmit(e) {
      ...
      if (res.status === 200) {
        ...
        form.reset();
        var alertNode = document.createElement('div');
        var alertText = document.createTextNode('Time Card Submitted Successfully');
        alertNode.appendChild(alertText);
        alertNode.className = "alert alert-success";
        alertSpace.appendChild(alertNode);
      } else {
            ...
            <Form onSubmit={onSubmit}>
              ...
              <Col md={4}>
                ...
                <Col md={4}>
                    <FormGroup>
                    <Label for="week1">Hours worked 1<sup>st</sup>-7<sup>th</sup></Label>
                    <Input type="number" min="0" name="week1" id="week1" placeholder="" />
                    </FormGroup>
                </Col>
                </Row>
                <Row form>
                <Col md={4}>
                    <FormGroup>
                    <Label for="week2">Hours worked 8<sup>th</sup>-14<sup>th</sup></Label>
                    <Input type="number" min="0" name="week2" id="week2" placeholder="" />
                    </FormGroup>
                </Col>
                </Row>
                <Row form>
                <Col md={4}>
                    <FormGroup>
                    <Label for="week3">Hours worked 15<sup>th</sup>-21<sup>st</sup></Label>
                    <Input type="number" min="0" name="week3" id="week3" placeholder="" />
                    </FormGroup>
                </Col>
                </Row>
                <Row form>
                <Col md={4}>
                    <FormGroup>
                    <Label for="week4">Hours worked 22<sup>nd</sup>-28<sup>th</sup></Label>
                    <Input type="number" min="0" name="week4" id="week4" placeholder="" />
                    </FormGroup>
                </Col>
                </Row>
                <Row form>
                <Col md={4}>
                    <FormGroup>
                    <Label for="week5">Hours worked 29<sup>th</sup>-31<sup>th</sup></Label>
                    <Input type="number" min="0" name="week5" id="week5" placeholder="" />
                    </FormGroup>
                </Col>
                </Row>
                <Row form>
            ...
            user?.role == 'professor'?
              <>
                  ...
                  <Row id="unapprovedCards">
                    {timecards.map((timecard) => <TimeCardDisplay timecard={timecard}/>)}
                  </Row>
                  </Container>
              </>:
              <></>
...
export async function getServerSideProps(context) {
    ...
    if (user?.role == 'professor'){
      ...
      for(let i=0; i<timecards.length;i++){
        timecards[i].studentName = extractUser(await findUserById(context.req.db, timecards[i].userId)).name;
